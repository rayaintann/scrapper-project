...
| Tier | ✅ Ada | `followers_count` terisi 7.498. Ada juga tabel `kol_tiers`, tapi batasnya beda dari UI |
...
| Verified | ✅ Ada | `verified_status`: 454 verified · 477 unverified · 6.789 kosong |
...
| Growth 30 hari | ❌ Tidak ada | Belum ada satu akun pun yang punya 2 data berjarak 30 hari |
